...
const translations = {
  tr: {
    ...
    all: 'Hepsi',
    amountInCurrency: 'Tutar ({currency})',
    amountTry: 'Tutar (TRY)',
    adminCategoryRecords: 'Kategori kayıtları',
    adminDataLoadFailed: 'Admin verileri alınamadı. Yetki ve bağlantı durumunu kontrol edin.',
    adminExpenseRecords: 'Gider kayıtları',
    adminPanelSubtitle: 'Kullanıcı ve sistem özeti',
    adminPanelTitle: 'Admin Paneli',
    adminRegisteredUsers: 'Kayıtlı kullanıcılar',
    adminRoleAdmin: 'Admin',
    adminRoleLoadFailed: 'Kullanıcı rolü alınamadı. Normal ekran açıldı.',
    adminRoleUser: 'User',
    adminSettingsRecords: 'Ayar kayıtları',
    adminUserListSubtitle: '{count} kullanıcı listeleniyor',
    adminUserListTitle: 'Kullanıcılar',
    adminWelcomeText: '{email} hesabı admin yetkisiyle giriş yaptı.',
    adminWelcomeTitle: 'Genel Bakış',
    ...
    authGenericError: 'Giriş işlemi tamamlanamadı. Bilgilerini kontrol edip tekrar deneyin.',
    authPasswordMin: 'Lütfen en az 6 karakterli şifre girin.',
    authServiceUnavailable: 'Giriş servisi şu anda yapılandırılamadı. Lütfen daha sonra tekrar deneyin.',
    ...
    deleteAccountConfirm:
      'Hesabınızı silmek istediğinize emin misiniz? Bu işlem geri alınamaz ve tüm finansal verileriniz silinecektir.',
    deleteAccountDescription: 'Hesabını, oturumunu ve PocketWallet finansal verilerini kalıcı olarak sil.',
    deleteAccountFailed: 'Hesap silinemedi. Bağlantını kontrol edip tekrar deneyin.',
    deleteAccountFailedTitle: 'Hesap Silinemedi',
    deleteExpenseFailed: 'Gider silinemedi, kayıt geri yüklendi.',
    emailPlaceholder: 'E-posta',
    expenseCurrency: 'Gider Para Birimi',
    expenseDescription: 'Gider açıklaması (opsiyonel)',
    expenseEnteredAs: '{amount} {currency} olarak girildi',
    ...
    incomeEnteredAs: '{amount} {currency} olarak girildi',
    incomeSaveFailed: 'Gelir buluta kaydedilemedi, yerel kayıt korundu.',
  ...
  en: {
    ...
    all: 'All',
    amountInCurrency: 'Amount ({currency})',
    amountTry: 'Amount (TRY)',
    adminCategoryRecords: 'Category records',
    adminDataLoadFailed: 'Admin data could not be loaded. Check permissions and connection.',
    adminExpenseRecords: 'Expense records',
    adminPanelSubtitle: 'User and system overview',
    adminPanelTitle: 'Admin Panel',
    adminRegisteredUsers: 'Registered users',
    adminRoleAdmin: 'Admin',
    adminRoleLoadFailed: 'User role could not be loaded. The regular screen was opened.',
    adminRoleUser: 'User',
    adminSettingsRecords: 'Settings records',
    adminUserListSubtitle: '{count} users listed',
    adminUserListTitle: 'Users',
    adminWelcomeText: '{email} signed in with admin access.',
    adminWelcomeTitle: 'Overview',
    ...
    authGenericError: 'We could not complete sign-in. Please check your details and try again.',
    authPasswordMin: 'Please enter a password with at least 6 characters.',
    authServiceUnavailable: 'The sign-in service is not configured right now. Please try again later.',
    ...
    deleteAccountConfirm:
      'Are you sure you want to delete your account? This action cannot be undone and all of your financial data will be deleted.',
    deleteAccountDescription: 'Permanently delete your account, session, and PocketWallet financial data.',
    deleteAccountFailed: 'We could not delete your account. Check your connection and try again.',
    ...
    expenseEnteredAs: 'Entered as {amount} {currency}',
    ...
    incomeEnteredAs: 'Entered as {amount} {currency}',
    incomeSaveFailed: 'Income could not be saved to the cloud, local record was kept.',
