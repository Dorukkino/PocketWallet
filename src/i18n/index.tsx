...
const translations = {
  tr: {
    ...
    advicePositive:
      'Bu ay %{percent} tasarruf alanın var. Kalan bütçeyi yatırım veya birikim için ayırabilirsin.',
    all: 'Hepsi',
    amountTry: 'Tutar (TRY)',
    ...
    authEmailPasswordError: 'E-posta ve en az 6 karakterli şifre girin.',
    ...
    expensePlaceholder: 'Örn: market, fatura, sinema',
    expenseSaveFailed: 'Gider buluta kaydedilemedi, yerel kayıt korundu.',
    financialAdvice: 'Finansal Öneri',
    ...
    writeExpenseTitleError: 'Lütfen gider açıklaması yazın.',
  ...
  en: {
    ...
    advicePositive: 'You have %{percent} savings room this month. You can set the remaining budget aside for investing or saving.',
    all: 'All',
    ...
    authEmailPasswordError: 'Enter an email and a password with at least 6 characters.',
    ...
    expensePlaceholder: 'Ex: groceries, bill, cinema',
    ...
    writeExpenseTitleError: 'Please write an expense description.',
    categoryBills: 'Bills',
...
const commonCategoryLabels: Record<string, CategoryConcept> = {
  ...
  ...makeCategoryAliases({ tr: 'Mutfak', en: 'Kitchen' }, [
    'mutfak',
    'kitchen',
    'market',
    'süpermarket',
